...
begin
 ...
 if gf = 1 then begin
   if trim(apeynom.Text)='' then begin   // responsable
     messagedlg('ERROR!! NO se Ingreso ningun Responsable de la Exhumación!!',mterror,[mbok],0);
     JvBitBtn0.SetFocus;
   end
   else begin
  ...
  Function Logo(posx,posy:double;vaf:integer):double;
   ...
   begin
    with RvOrden do begin
     ...
     BaseReport.PrintXY(posx+145,posy+27,'ORDEN Nº:');
     ...
     BaseReport.PrintXY(posx+5,posy+43,'Servicio Nº');
