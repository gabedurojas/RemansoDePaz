...
uses
  ...
  ClaseParcelasMantenimientoPreciosBis,
...
begin
 ...
 if nro=1 then begin
  ...
  + 'DescuentoAnual FROM ParcelasMantenimientoPrecios  where FechaFin is null ORDER BY Id DESC';
...
procedure TActuValorManteMes.admKeyPress(Sender: TObject; var Key: Char);
begin
if key = #13 then begin
  Key := #0;
  guarda.SetFocus;
