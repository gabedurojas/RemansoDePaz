object Estad_movVentas: TEstad_movVentas
  Left = 314
  Top = 9
  AutoScroll = False
  Caption = 'Movimientos De Ventas (Libro Ventas)'
  ClientHeight = 528
  ClientWidth = 794
  Color = clBtnFace
  ...
  object GroupBox1: TGroupBox
    ...
    object Movim: TComboBox
      ...
      Text = 'PERIODO'
      OnExit = MovimExit
      OnKeyPress = MovimKeyPress
    end
    object comprobante: TComboBox
      Left = 20
      Top = 90
      Width = 203
      Height = 21
      ...
      TabOrder = 7
      Text = 'PERIODO'
      OnExit = comprobanteExit
      OnKeyPress = comprobanteKeyPress
    end
  end
