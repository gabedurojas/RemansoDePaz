...
type
  ...
  public
    ...
    valorcuota:real;
    coefi,inter,porcent,name,ElI,ElId,losinhu:string;
...
procedure TVen_TraslaGer.FormActivate(Sender: TObject);
begin
...
procedure TVen_TraslaGer.FormCreate(Sender: TObject);
begin
gh:=false;
end;

procedure TVen_TraslaGer.Coloca1(nro:byte);
...
if nro=2 then begin   //precio del servicio por nivel
    ...
    if TiposServiciosNivel.Listar(txtw,DataSet1)  then begin
      ...
      importee.Text:=trim(DataSet1.Fields[3].AsString);
    end
    ...
    if ct then begin
       ...
       if losinhu <> '0' then begin
          ...
          try
            ...
            InhuSinServ.Caption:='Lista de Inhumados sin Servicios';
...
//  if trim(edit2.Text)<> '4' then  begin
    txtw:='SELECT * FROM CreaDeudasServiciosEspecial ('+ chr(39) +trim(fecha.Text)+ chr(39) +','+ trim(saldo.text)+ ','+ trim(edit2.Text)+ ',3) ' +
      'where nrocuota=0 union '
    + 'SELECT * FROM CreaDeudasServiciosEspecialCuotas ('+ chr(39) +trim(fecha.Text)+ chr(39) +','+ trim(edit2.Text)+ ',' + trim(importee.Text) + ')';
//  end;
//  if trim(edit2.Text)= '4' then  begin
//    txtw:='SELECT * FROM CreaDeudasServiciosEspecial (' + chr(39) +trim(fecha.Text)+ chr(39) + ',' + trim(importee.Text)
//          +','+ trim(edit2.Text)+','+ trim(nivel1.text) +')';
//  end;
  if not Funciones.Listar(txtw,DtCombo) then
     messagedlg('ERROR al realizar Transac-SQL. Consulte con Administrador',mtError,[mbok],0);
  Funciones.Free;
...
procedure TVen_TraslaGer.DBGrid1CellClick(Column: TColumn);
var txt:widestring;
begin
...
procedure TVen_TraslaGer.BuscaClick(Sender: TObject);
var p,u:integer;
begin
Coloca1(1);
...
procedure TVen_TraslaGer.JvBitBtn3Click(Sender: TObject);
begin
Close;
end;

procedure TVen_TraslaGer.bExportarClick(Sender: TObject);
...
procedure TVen_TraslaGer.ONOMBKeyPress(Sender: TObject; var Key: Char);
begin
if key = #13 then busca.SetFocus;

end;

procedure TVen_TraslaGer.ODNIKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TVen_TraslaGer.IMPORTEEExit(Sender: TObject);
var vSaldo:double;
...
procedure TVen_TraslaGer.IMPORTEEKeyPress(Sender: TObject; var Key: Char);
begin
if key = #13 then begin
  Key := #0;
  tpopago.SetFocus;
...
procedure TVen_TraslaGer.SaldoKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TVen_TraslaGer.FECHAKeyPress(Sender: TObject; var Key: Char);
begin
  if key = #13 then begin
    Key := #0;
...
procedure TVen_TraslaGer.FECHAExit(Sender: TObject);
var fec:Tdatetime;
begin
try
...
procedure TVen_TraslaGer.DPrecioKeyPress(Sender: TObject; var Key: Char);
begin
if key = #13 then begin
...
procedure TVen_TraslaGer.DPrecioExit(Sender: TObject);
begin
...
procedure TVen_TraslaGer.bGuardarClick(Sender: TObject);
...
procedure TVen_TraslaGer.bSalirClick(Sender: TObject);
begin
Close;
end;

procedure TVen_TraslaGer.tpopagoKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TVen_TraslaGer.tpopagoExit(Sender: TObject);
var t:integer;
...
if tpopago.ItemIndex < 0 then begin
  ...
  tpopago.SetFocus;
     ...
     if tpopago.itemindex = 1 then begin
        ...
        vEntrega:= strtofloat(preciol.text)/2;
...
procedure TVen_TraslaGer.OBSERVKeyPress(Sender: TObject; var Key: Char);
begin
if key = #13 then begin
  Key := #0;
...
procedure TVen_TraslaGer.OPERAExit(Sender: TObject);
var t,suma:integer;
begin
...
procedure TVen_TraslaGer.OPERAKeyPress(Sender: TObject; var Key: Char);
begin
if key = #13 then begin
  Key := #0;
  cocherias.SetFocus;
...
procedure TVen_TraslaGer.TIPOOBJETOExit(Sender: TObject);
begin
...
procedure TVen_TraslaGer.TIPOOBJETOKeyPress(Sender: TObject; var Key: Char);
begin
if key = #13 then begin
  Key := #0;
  VerificaNP.SetFocus;
...
procedure TVen_TraslaGer.verificaNPClick(Sender: TObject);
...
procedure TVen_TraslaGer.DesactivarObjeto1Click(Sender: TObject);
var t,suma:integer;
begin
...
procedure TVen_TraslaGer.DBGrid1DrawColumnCell(Sender: TObject;
...
procedure TVen_TraslaGer.Edit2KeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TVen_TraslaGer.Edit2Exit(Sender: TObject);
begin
if trim(codigo.Text)='FINANCIADO SIN INTERESES' then begin
  coloca1(18);
  tipopago:=7;
...
procedure TVen_TraslaGer.Edit2Change(Sender: TObject);
begin
//if trim(codigo.Text)='FINANCIADO SIN INTERESES' then begin
// coloca1(9);
//  tipopago:=7;
...
procedure TVen_TraslaGer.TARJETAExit(Sender: TObject);
begin
...
procedure TVen_TraslaGer.NroCuotaExit(Sender: TObject);
begin
...
procedure TVen_TraslaGer.NroCuotaKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TVen_TraslaGer.NROCBKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TVen_TraslaGer.NROCBExit(Sender: TObject);
begin
...
procedure TVen_TraslaGer.TARJETAKeyPress(Sender: TObject; var Key: Char);
begin
if key = chr(13) then tittarje.SetFocus;
end;

procedure TVen_TraslaGer.ftarjeExit(Sender: TObject);
var fec:Tdatetime;
begin
try
...
procedure TVen_TraslaGer.ftarjeKeyPress(Sender: TObject; var Key: Char);
begin
if key = #13 then edit3.SetFocus;
end;

procedure TVen_TraslaGer.Edit3Exit(Sender: TObject);
begin
...
procedure TVen_TraslaGer.Edit3KeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TVen_TraslaGer.bancoExit(Sender: TObject);
begin
...
procedure TVen_TraslaGer.bancoKeyPress(Sender: TObject; var Key: Char);
begin
if key = chr(13) then titcheq.SetFocus;
end;

procedure TVen_TraslaGer.titcheqKeyPress(Sender: TObject; var Key: Char);
begin
if key = chr(13) then E1.SetFocus;
end;

procedure TVen_TraslaGer.E1KeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TVen_TraslaGer.E2Exit(Sender: TObject);
begin
...
procedure TVen_TraslaGer.E2KeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TVen_TraslaGer.FchequeExit(Sender: TObject);
var fec:Tdatetime;
begin
try
...
procedure TVen_TraslaGer.FchequeKeyPress(Sender: TObject; var Key: Char);
begin
if key = #13 then fpagocheque.SetFocus;
end;

procedure TVen_TraslaGer.fpagochequeExit(Sender: TObject);
var fec:Tdatetime;
begin
try
...
procedure TVen_TraslaGer.fpagochequeKeyPress(Sender: TObject; var Key: Char);
begin
if key = #13 then e5.SetFocus;
end;

procedure TVen_TraslaGer.E5Exit(Sender: TObject);
begin
...
procedure TVen_TraslaGer.E5KeyPress(Sender: TObject; var Key: Char);
begin
  if key = #13 then observ.SetFocus
  else begin
    if ( StrScan('0123456789',Key) <> nil ) or
...
procedure TVen_TraslaGer.BORRAClick(Sender: TObject);
var u,p:integer;
begin
...
procedure TVen_TraslaGer.tittarjeKeyPress(Sender: TObject; var Key: Char);
begin
if key = chr(13) then nrocuota.SetFocus;
end;

procedure TVen_TraslaGer.titcheqExit(Sender: TObject);
begin
...
procedure TVen_TraslaGer.CODIGOChange(Sender: TObject);
begin
if trim(codigo.Text)='CONTADO' then tipopago:=2;
if trim(codigo.Text)='CHEQUE' then tipopago:=4;
if trim(codigo.Text)='TARJETA CREDITO' then tipopago:=3;
...
procedure TVen_TraslaGer.RvSPrint(Sender: TObject);
...
//          end;
//        end;
        if (grupocheq.Visible) or (grupotarje.Visible) then begin
           posy:=posy + 25
...
procedure TVen_TraslaGer.VALCUOTAKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TVen_TraslaGer.recibonroKeyPress(Sender: TObject; var Key: Char);
begin
if key = #13 then OBSERV.SetFocus;
end;

procedure TVen_TraslaGer.PrecioXnKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TVen_TraslaGer.PrecioLKeyPress(Sender: TObject; var Key: Char);
begin
if key = #13 then precioche.setfocus//CODIGO.SetFocus
else begin
  if ( StrScan('0123456789.',Key) <> nil ) or
...
procedure TVen_TraslaGer.preciocheKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TVen_TraslaGer.cocheriasExit(Sender: TObject);
begin
...
procedure TVen_TraslaGer.cocheriasKeyPress(Sender: TObject; var Key: Char);
begin
if key = #13 then begin
  Key := #0;
  tipoobjeto.SetFocus;
...
procedure TVen_TraslaGer.nivel1KeyPress(Sender: TObject; var Key: Char);
begin
if key = #13 then begin
  Key := #0;
  posicion1.SetFocus;
...
procedure TVen_TraslaGer.posicion1KeyPress(Sender: TObject; var Key: Char);
begin
if key = #13 then begin
  Key := #0;
  precioxn.SetFocus;
