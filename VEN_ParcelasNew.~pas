...
var
  Ven_ParcelaGer: TVen_ParcelaGer;
    parp:boolean;
implementation
...
procedure TVen_ParcelaGer.FormActivate(Sender: TObject);
var niv:integer;
begin
...
procedure TVen_ParcelaGer.FormCreate(Sender: TObject);
begin
gh:=false;
end;

procedure TVen_ParcelaGer.Coloca1(nro:byte);
var t,y,p,b:integer;
...
if nro=5 then begin //  financiado sin interes
  ...
  //txtw:='SELECT * FROM CreaDeudasVentas (1,' + chr(39) +trim(fecha.Text)+ chr(39)
  //+ ',' + trim(importee.Text) +',' + trim (dprecio.Text)+','+ trim(edit2.Text)+',0)';
  ...
  if c4.Checked=true then begin
   for p:=1 to GrillaT.RowCount-1 do begin
    if trim(grillaT.Cells[1,p]) = '?' then begin
     ...
     if (nroopcion = 2) or (nroopcion = 1)  then begin
      if pt then begin
       messagedlg('La Venta se ha Guardado con Exito',mtConfirmation,[mbok],0);
       /// pongo en false el anterior titular
       txtw:='UPDATE ParcelasTitulares SET Activo= 0 WHERE (NroTipoAcc=1) and (nivel=0) and (NroAccion= ' + trim(d1.Text) + ')';
       parcelastitulares.ListarSinResp(txtw);
       end
       else messagedlg('Error al Guardar esta TRANSFERENCIA. Consulte con un Administrador',mtError,[mbok],0);
     end
   ...
   for p:=1 to GrillaT.RowCount-1 do begin
    if trim(grillaT.Cells[1,p]) = '?' then begin
     ...
     if nroopcion = 3  then begin
      ...
      if pt then begin
        messagedlg('La TRANSFERENCIA se ha Guardado con Exito',mtConfirmation,[mbok],0);
        txtw:='UPDATE ParcelasTitulares SET Activo= 0 WHERE (NroTipoAcc=1) and (NroAccion= ' + trim(d1.Text) + ')';
        parcelastitulares.ListarSinResp(txtw);
      end
       else Barra1.SimpleText:='Error al Guardar los Titulares';
     end;
...
if nro=14 then begin
  ...
  if trim(codigo.Text)='CHEQUE' then
   ...
   //+' FROM CreaDeudasVentas (1,' + chr(39) + trim(fecha.Text) + chr(39) +',0,'+ trim(e5.Text) +',1,0)';
   txtw:='select nrocuota,periodo,fechavto,capital,interes,montocuota,''Cheque'' as detalle '
  ...
  if trim(codigo.Text)='TARJETA DE CREDITO' then
    ...
    +' FROM CreaDeudasVentas (1,' + chr(39) + trim(fecha.Text) + chr(39) +',0,'+ trim(dprecio.Text) +',1,0)';
   //txtw:='select nrocuota,periodo,fechavto,capital,interes,montocuota,''Tarjeta Credito'' as detalle '
   //+' FROM CreaDeudasVentas (1,' + chr(39) + trim(fecha.Text) + chr(39) +',0,'+trim(saldo.Text) +',1,0)';
  if not Funciones.Listar(txtw,DtCombo) then
     messagedlg('ERROR al realizar Transac-SQL. Consulte con Administrador',mtError,[mbok],0);
  Funciones.Free;
  for t:=0 to grilla5.ColCount-1 do
...
procedure TVen_ParcelaGer.CargaDatos(nro:byte);
begin
 if nro=1 then begin
...
procedure TVen_ParcelaGer.DBGrid1CellClick(Column: TColumn);
var niv:integer;
begin
...
procedure TVen_ParcelaGer.BuscaClick(Sender: TObject);
var p,u:integer;
begin
 Coloca1(1);
...
procedure TVen_ParcelaGer.JvBitBtn3Click(Sender: TObject);
begin
  GroupBox12.Visible :=FALSE;
end;

procedure TVen_ParcelaGer.bExportarClick(Sender: TObject);
...
procedure TVen_ParcelaGer.ONOMBKeyPress(Sender: TObject; var Key: Char);
begin
if key = #13 then busca.SetFocus;

end;

procedure TVen_ParcelaGer.ODNIKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TVen_ParcelaGer.IMPORTEEExit(Sender: TObject);
//var vSaldo:double;
...
procedure TVen_ParcelaGer.IMPORTEEKeyPress(Sender: TObject; var Key: Char);
begin
{ if key = #13 then begin
  if tpopago.itemindex = 0 then begin
   Key := #0;
...
procedure TVen_ParcelaGer.SaldoKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TVen_ParcelaGer.IMPORTEKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TVen_ParcelaGer.FECHAKeyPress(Sender: TObject; var Key: Char);
var Seleccion_Cuotas: TSeleccion_Cuotas;
begin
if key = #13 then begin
 Key := #0;
...
procedure TVen_ParcelaGer.FECHAExit(Sender: TObject);
var fec:Tdatetime;
begin
try
...
procedure TVen_ParcelaGer.DPrecioKeyPress(Sender: TObject; var Key: Char);
begin
 if key = #13 then begin
  tpopago.SetFocus;
 end
...
procedure TVen_ParcelaGer.DPrecioExit(Sender: TObject);
begin
...
procedure TVen_ParcelaGer.bGuardarClick(Sender: TObject);
...
procedure TVen_ParcelaGer.ImprimirActaClick(Sender: TObject);
var gf:integer;
begin
...
procedure TVen_ParcelaGer.ImprimeReglamentoClick(Sender: TObject);
var gf:integer;
begin
...
procedure TVen_ParcelaGer.ImprimirCesionClick(Sender: TObject);
var gf:integer;
begin
...
procedure TVen_ParcelaGer.ImprimirClausularClick(Sender: TObject);
var gf:integer;
begin
...
procedure TVen_ParcelaGer.ImprimirGarantiaClick(Sender: TObject);
var gf:integer;
begin
...
procedure TVen_ParcelaGer.ImprimirCartaClick(Sender: TObject);
var gf:integer;
begin
...
procedure TVen_ParcelaGer.bSalirClick(Sender: TObject);
begin
 Close;
end;

Procedure TVen_ParcelaGer.SolicitudAdquisicion();
...
procedure TVen_ParcelaGer.Cesion();
var posx,posy:double;
...
procedure TVen_ParcelaGer.Clausulas();
var posx,posy:double;
    t,hoja:integer;
    ElMes,ElAnio,ElDia: string;
    Imagen1:  TBitmap;
...
procedure TVen_ParcelaGer.Garantias();
var posx,posy:double;
    hoja:integer;
    ElMes,ElAnio,ElDia: string;
    Imagen1:  TBitmap;
...
procedure TVen_ParcelaGer.Reglamento();
var posx,posy:double;
    t,hoja:integer;
    Imagen1:  TBitmap;
...
procedure TVen_ParcelaGer.Reglamento1();
var posx,posy:double;
    t,hoja:integer;
    Imagen1:  TBitmap;
    Fuente,PathLogo:string;
...
procedure TVen_ParcelaGer.RvSCartaPrint(Sender: TObject);
var gf:integer;
begin
  Carta;
end;

procedure TVen_ParcelaGer.Carta();
var posx,posy:double;
    hoja:integer;
    ElMes,ElAnio,ElDia: string;
...
procedure TVen_ParcelaGer.RvSPrint(Sender: TObject);
begin
...
procedure TVen_ParcelaGer.tpopagoKeyPress(Sender: TObject; var Key: Char);
begin
 if key = #13 then begin
  if tpopago.itemindex = 0 then begin
...
procedure TVen_ParcelaGer.tpopagoExit(Sender: TObject);
var t:integer;
var val,tot:real;
begin
 if tpopago.ItemIndex < 0 then begin
...
procedure TVen_ParcelaGer.OBSERVKeyPress(Sender: TObject; var Key: Char);
begin
 if key = #13 then begin
  Key := #0;
  gdatos.ActivePage:=gdatos.Pages[0];
...
procedure TVen_ParcelaGer.Button2Click(Sender: TObject);
...
procedure TVen_ParcelaGer.ControlTitulares();
var t:integer;
begin
  cantt:=0;
  for t:=1 to GrillaT.RowCount-1 do begin
...
procedure TVen_ParcelaGer.Agrega2Click(Sender: TObject);
var t:integer;
...
procedure TVen_ParcelaGer.Modifica2Click(Sender: TObject);
...
procedure TVen_ParcelaGer.Quita2Click(Sender: TObject);
begin
  EDIT1.Text:='00000000000';
  name:='';
  tdoc:='';
...
procedure TVen_ParcelaGer.Borra2Click(Sender: TObject);
var t,p,gf:integer;
var bt:boolean;
begin
...
procedure TVen_ParcelaGer.GrillaTClick(Sender: TObject);
begin
  Agrega2.Enabled:=false;
  Borra2.Enabled:=true;
  Quita2.Enabled:=true;
...
procedure TVen_ParcelaGer.Edit1Exit(Sender: TObject);
begin
...
procedure TVen_ParcelaGer.Edit1KeyPress(Sender: TObject; var Key: Char);
begin
 if key = #13 then begin
  Key := #0;
...
procedure TVen_ParcelaGer.grillaformuClick(Sender: TObject);
var t,y:integer;
begin
 detalledeimp:='';
 GroupBox8.Visible :=false;
...
procedure TVen_ParcelaGer.DBGrid1DrawColumnCell(Sender: TObject;
...
procedure TVen_ParcelaGer.ElSectorExit(Sender: TObject);
begin
...
procedure TVen_ParcelaGer.ElSectorKeyPress(Sender: TObject; var Key: Char);
begin
 if key = #13 then begin
  Key := #0;
  coloca1(4);
...
procedure TVen_ParcelaGer.LaAccionExit(Sender: TObject);
begin
...
procedure TVen_ParcelaGer.LaAccionKeyPress(Sender: TObject; var Key: Char);
begin
 if key = #13 then begin
  Key := #0;
  coloca1(2);
...
procedure TVen_ParcelaGer.Edit2Change(Sender: TObject);
begin
  if trim(codigo.Text)='FINANCIADO SIN INTERES' then begin
   coloca1(5);
   tipopago:=7;
  ...
  //bGuardar.Enabled:=true;
  if tpopago.ItemIndex=0 then BEGIN
   //if trim(codigo.Text)='CONTADO' then observ.Text:='Pago Contado ' + NumToPesos(trim(valcuota.text)) + ' $' + trim(valcuota.text);
   //if trim(codigo.Text)='CUENTA CORRIENTE' then observ.Text:='Pago Contado ' + NumToPesos(trim(valcuota.text)) + ' $' + trim(valcuota.text);
   // else observ.Text:='Pago Cu ' + NumToPesos(trim(valcuota.text)) + ' $' + trim(valcuota.text);
...
procedure TVen_ParcelaGer.Edit2KeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TVen_ParcelaGer.Edit2Exit(Sender: TObject);
begin
  if trim(codigo.Text)='FINANCIADO SIN INTERES' then begin
   coloca1(5);
   tipopago:=7;
...
procedure TVen_ParcelaGer.TARJETAExit(Sender: TObject);
begin
...
procedure TVen_ParcelaGer.NroCuotaExit(Sender: TObject);
var tot:real;
begin
...
procedure TVen_ParcelaGer.NroCuotaKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TVen_ParcelaGer.NROCBKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TVen_ParcelaGer.TARJETAKeyPress(Sender: TObject; var Key: Char);
begin
if key = chr(13) then tittarje.SetFocus;
end;

procedure TVen_ParcelaGer.NROCBExit(Sender: TObject);
begin
...
procedure TVen_ParcelaGer.bancoKeyPress(Sender: TObject; var Key: Char);
begin
if key = chr(13) then titcheq.SetFocus;
end;

procedure TVen_ParcelaGer.E1KeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TVen_ParcelaGer.E2KeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TVen_ParcelaGer.ftarjeKeyPress(Sender: TObject; var Key: Char);
begin
if key = #13 then edit3.SetFocus;
end;

procedure TVen_ParcelaGer.ftarjeExit(Sender: TObject);
var fec:Tdatetime;
begin
try
...
procedure TVen_ParcelaGer.FchequeExit(Sender: TObject);
var fec:Tdatetime;
begin
try
...
procedure TVen_ParcelaGer.fpagochequeExit(Sender: TObject);
var fec:Tdatetime;
begin
try
...
procedure TVen_ParcelaGer.FchequeKeyPress(Sender: TObject; var Key: Char);
begin
if key = #13 then fpagocheque.SetFocus;
end;

procedure TVen_ParcelaGer.fpagochequeKeyPress(Sender: TObject;
  var Key: Char);
begin
 if key = #13 then begin
...
procedure TVen_ParcelaGer.E5KeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TVen_ParcelaGer.E5Exit(Sender: TObject);
begin
...
procedure TVen_ParcelaGer.Edit3Exit(Sender: TObject);
begin
...
procedure TVen_ParcelaGer.Edit3KeyPress(Sender: TObject; var Key: Char);
begin
 if key = #13 then //OBSERV.SetFocus
   if button2.Enabled then  button2.Click
 else begin
...
procedure TVen_ParcelaGer.titcheqKeyPress(Sender: TObject; var Key: Char);
begin
if key = chr(13) then E1.SetFocus;
end;

procedure TVen_ParcelaGer.tittarjeKeyPress(Sender: TObject; var Key: Char);
begin
if key = chr(13) then nrocuota.SetFocus;
end;

procedure TVen_ParcelaGer.BORRAClick(Sender: TObject);
var u,p:integer;
begin
...
procedure TVen_ParcelaGer.bancoExit(Sender: TObject);
begin
...
procedure TVen_ParcelaGer.PorcenExit(Sender: TObject);
begin
...
procedure TVen_ParcelaGer.PorcenKeyPress(Sender: TObject; var Key: Char);
var tot:real;
begin
 if key = #13 then begin
  Key := #0;
...
procedure TVen_ParcelaGer.PorcenChange(Sender: TObject);
var tot:real;
begin
 if trim(porcen.text) <> '0' then begin
  tot:= strtofloat(dprecio.Text) * strtoint(porcen.text)/ 100;
...
procedure TVen_ParcelaGer.titcheqExit(Sender: TObject);
begin
...
procedure TVen_ParcelaGer.preciopExit(Sender: TObject);
begin
...
procedure TVen_ParcelaGer.preciopKeyPress(Sender: TObject; var Key: Char);
begin
 if key = #13 then begin
   dprecio.SetFocus;
 end
...
procedure TVen_ParcelaGer.VALCUOTAKeyPress(Sender: TObject; var Key: Char);
begin
 if key = #13 then begin
  if trim(codigo.Text)='FINANCIADO SIN INTERES' then begin
     coloca1(5);
...
procedure TVen_ParcelaGer.RvDPrint(Sender: TObject);
...
procedure TVen_ParcelaGer.recibonroKeyPress(Sender: TObject;
  var Key: Char);
begin
//if key = #13 then OBSERV.SetFocus;
end;

procedure TVen_ParcelaGer.E2Exit(Sender: TObject);
begin
...
procedure TVen_ParcelaGer.JvBitBtn1Click(Sender: TObject);
begin
  Rvs.SystemPrinter.Copies :=2;
  NroOpc:=5;
  RvS.Execute;
...
procedure TVen_ParcelaGer.JvBitBtn2Click(Sender: TObject);
begin
  Rvs.SystemPrinter.Copies :=2;
  NroOpc:=7;
  RvS.Execute;
...
procedure TVen_ParcelaGer.EXPORTARClick(Sender: TObject);
begin
 rvd.Execute;
end;

procedure TVen_ParcelaGer.actuClick(Sender: TObject);
begin
 tipocomprob:='Segun pago ' + trim(tpotalon.Text) + ' - ' + StrFill(PV.Text,3,'0','') + '-' + StrFill(elcomprob.Text,8,'0','');
 grupoimp.Enabled :=true;
end;

procedure TVen_ParcelaGer.TPOTALONExit(Sender: TObject);
begin
...
procedure TVen_ParcelaGer.PVExit(Sender: TObject);
begin
...
procedure TVen_ParcelaGer.elcomprobChange(Sender: TObject);
begin
 actu.Enabled :=true;
end;

procedure TVen_ParcelaGer.elcomprobExit(Sender: TObject);
begin
...
procedure TVen_ParcelaGer.TPOTALONKeyPress(Sender: TObject; var Key: Char);
begin
if key = chr(13) then pv.SetFocus;
end;

procedure TVen_ParcelaGer.PVKeyPress(Sender: TObject; var Key: Char);
begin
if key = chr(13) then elcomprob.SetFocus;
end;

procedure TVen_ParcelaGer.elcomprobKeyPress(Sender: TObject;
  var Key: Char);
begin
  if key = #13 then begin
    Key := #0;
...
procedure TVen_ParcelaGer.VALCUOTAExit(Sender: TObject);
begin
