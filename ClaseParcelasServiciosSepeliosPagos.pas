unit ClaseParcelasServiciosSepeliosPagos;
...
type
  TParcelasServiciosSepeliosPagos= Class(TObject)
  private
  { Private declarations }
    ...
    procedure SetIdServicioSepelios(Value:variant);
  ...
  public
    ...
    property C_IdServicioSepelios:variant read FIdServicioSepelios write SetIdServicioSepelios;
...
constructor TParcelasServiciosSepeliosPagos.Create(AOwner:TComponent);
begin
  inherited Create();
  FCountFields:=32;
end;

procedure TParcelasServiciosSepeliosPagos.SetConnectionString(Value:widestring);
begin
  FConnectionString:=Value;
end;

procedure TParcelasServiciosSepeliosPagos.SetIdentidad(Value:string);
begin
  FIdentidad:=Value;
end;

procedure TParcelasServiciosSepeliosPagos.SetIsEmpty(Value:boolean);
begin
  FIsEmpty:=Value;
end;


procedure TParcelasServiciosSepeliosPagos.SetIdPago(Value:variant);
begin
  FIdPago:=Value;
end;

procedure TParcelasServiciosSepeliosPagos.SetIdServicioSepelios(Value:variant);
begin
  FIdServicioSepelios:=Value;
end;

procedure TParcelasServiciosSepeliosPagos.SetIdFormaPago(Value:variant);
begin
  FIdFormaPago:=Value;
end;

procedure TParcelasServiciosSepeliosPagos.SetFecha(Value:string);
begin
  FFecha:=Value;
end;

procedure TParcelasServiciosSepeliosPagos.SetNroCuota(Value:variant);
begin
  FNroCuota:=Value;
end;

procedure TParcelasServiciosSepeliosPagos.SetNroEntidad(Value:variant);
begin
  FNroEntidad:=Value;
end;

procedure TParcelasServiciosSepeliosPagos.SetNroSucursal(Value:variant);
begin
  FNroSucursal:=Value;
end;

procedure TParcelasServiciosSepeliosPagos.SetNroChequera(Value:variant);
begin
  FNroChequera:=Value;
end;

procedure TParcelasServiciosSepeliosPagos.SetNroCheque(Value:variant);
begin
  FNroCheque:=Value;
end;

procedure TParcelasServiciosSepeliosPagos.SetSerie(Value:string);
begin
  FSerie:=Value;
end;

procedure TParcelasServiciosSepeliosPagos.SetTitular(Value:string);
begin
  FTitular:=Value;
end;

procedure TParcelasServiciosSepeliosPagos.SetNroCuenta(Value:string);
begin
  FNroCuenta:=Value;
end;

procedure TParcelasServiciosSepeliosPagos.SetComprobante(Value:string);
begin
  FComprobante:=Value;
end;

procedure TParcelasServiciosSepeliosPagos.SetMonto(Value:variant);
begin
  FMonto:=Value;
end;

procedure TParcelasServiciosSepeliosPagos.SetInteres(Value:variant);
begin
  FInteres:=Value;
end;

procedure TParcelasServiciosSepeliosPagos.SetIDTipoComprobante(Value:variant);
begin
  FIDTipoComprobante:=Value;
end;

procedure TParcelasServiciosSepeliosPagos.SetPuntoVenta(Value:variant);
begin
  FPuntoVenta:=Value;
end;

procedure TParcelasServiciosSepeliosPagos.SetNroFactura(Value:variant);
begin
  FNroFactura:=Value;
end;

procedure TParcelasServiciosSepeliosPagos.SetNroComprobante(Value:string);
begin
  FNroComprobante:=Value;
end;

procedure TParcelasServiciosSepeliosPagos.SetObservaciones(Value:string);
begin
  FObservaciones:=Value;
end;

procedure TParcelasServiciosSepeliosPagos.SetFecha_A(Value:string);
begin
  FFecha_A:=Value;
end;

procedure TParcelasServiciosSepeliosPagos.SetUsu_A(Value:variant);
begin
  FUsu_A:=Value;
end;

procedure TParcelasServiciosSepeliosPagos.SetEnMovimientos(Value:boolean);
begin
  FEnMovimientos:=Value;
end;

procedure TParcelasServiciosSepeliosPagos.SetEsEntrega(Value:boolean);
begin
  FEsEntrega:=Value;
end;

procedure TParcelasServiciosSepeliosPagos.SetConfirmado(Value:boolean);
begin
  FConfirmado:=Value;
end;

procedure TParcelasServiciosSepeliosPagos.SetUsuConfirma(Value:variant);
begin
  FUsuConfirma:=Value;
end;

procedure TParcelasServiciosSepeliosPagos.SetFechaConfirma(Value:string);
begin
  FFechaConfirma:=Value;
end;

procedure TParcelasServiciosSepeliosPagos.SetAnulado(Value:boolean);
begin
  FAnulado:=Value;
end;

procedure TParcelasServiciosSepeliosPagos.SetUsuAnula(Value:variant);
begin
  FUsuAnula:=Value;
end;

procedure TParcelasServiciosSepeliosPagos.SetFechaAnula(Value:string);
begin
  FFechaAnula:=Value;
end;

procedure TParcelasServiciosSepeliosPagos.SetMotivoAnula(Value:string);
begin
  FMotivoAnula:=Value;
end;

procedure TParcelasServiciosSepeliosPagos.SetIdCobro(Value:variant);
begin
  FIdCobro:=Value;
end;

Function TParcelasServiciosSepeliosPagos.BuscarPK(ValorBuscado:String):boolean;
...
//Realizo la Consulta
Result:=FCapaDatos.BuscarSP('SPC_ParcelasServiciosSepeliosPagosConsultar',Parametros,DataSet,1);
if Result then begin
  //Realizo la Asignación a las Propiedades de la Clase
  IsEmpty:=DataSet.IsEmpty;
  C_IdPago_PK:=DataSet.FieldByName('IdPago').AsVariant;
  C_IdServicioSepelios:=DataSet.FieldByName('IdServicioSepelios').AsVariant;
...
Function TParcelasServiciosSepeliosPagos.ListarSP(var Parametros:TWideStrings; var DataSet:TClientDataSet; 
...
//Realizo la Consulta
Result:=FCapaDatos.BuscarSP('SPC_ParcelasServiciosSepeliosPagosConsultar',Parametros,DataSet,MaxRecord);

//Libero Memoria
FCapaDatos.Free;
end;

Function TParcelasServiciosSepeliosPagos.Listar(Consulta:widestring; var DataSet:TClientDataSet):boolean;
begin
//Instancio la Capa de Datos
FCapaDatos:=TCapaDatos.Create(nil);
FCapaDatos.ConnectionString:=FConnectionString;
...
Function TParcelasServiciosSepeliosPagos.ListarSinResp(Consulta:widestring):boolean;
begin
//Instancio la Capa de Datos
FCapaDatos:=TCapaDatos.Create(nil);
FCapaDatos.ConnectionString:=FConnectionString;
...
Function TParcelasServiciosSepeliosPagos.Agrega():boolean;
var DataSet:TClientDataSet;
    Parametros:TWideStrings;
begin
//Instancio el DataSet
...
//Cargo los Parmetros
if (C_IdServicioSepelios = NULL) then Parametros.Add('')
else Parametros.Add(VarToStr(C_IdServicioSepelios));
...
//Realizo la Consulta
Result:=FCapaDatos.BuscarSP('SPC_ParcelasServiciosSepeliosPagosInsertar',Parametros,DataSet,1);
...
Function TParcelasServiciosSepeliosPagos.Borrar(ValorBuscado:string):boolean;
...
//Realizo la Consulta
Result:=FCapaDatos.EjecutarSinResp('SPC_ParcelasServiciosSepeliosPagosEliminar',Parametros);
...
Function TParcelasServiciosSepeliosPagos.Modificar():boolean;
var Parametros:TWideStrings;
begin
//Instancio el Contenedor de Parametros
Parametros:=TWideStrings.Create;
...
//Realizo la Consulta
Result:=FCapaDatos.EjecutarSinResp('SPC_ParcelasServiciosSepeliosPagosModificar',Parametros);
