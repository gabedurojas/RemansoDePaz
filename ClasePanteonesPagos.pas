...
constructor TPanteonesPagos.Create(AOwner:TComponent);
begin
  inherited Create();
  FCountFields:=22;
end;

procedure TPanteonesPagos.SetConnectionString(Value:widestring);
begin
  FConnectionString:=Value;
end;

procedure TPanteonesPagos.SetIdentidad(Value:string);
begin
  FIdentidad:=Value;
end;

procedure TPanteonesPagos.SetIsEmpty(Value:boolean);
begin
  FIsEmpty:=Value;
end;


procedure TPanteonesPagos.SetIdPago(Value:variant);
begin
  FIdPago:=Value;
end;

procedure TPanteonesPagos.SetNroCuenta(Value:variant);
begin
  FNroCuenta:=Value;
end;

procedure TPanteonesPagos.SetIdPagoServ(Value:variant);
begin
  FIdPagoServ:=Value;
end;

procedure TPanteonesPagos.SetIdFormaPago(Value:variant);
begin
  FIdFormaPago:=Value;
end;

procedure TPanteonesPagos.SetFecha(Value:string);
begin
  FFecha:=Value;
end;

procedure TPanteonesPagos.SetMonto(Value:variant);
begin
  FMonto:=Value;
end;

procedure TPanteonesPagos.SetIDTipoComprobante(Value:variant);
begin
  FIDTipoComprobante:=Value;
end;

procedure TPanteonesPagos.SetPuntoVenta(Value:variant);
begin
  FPuntoVenta:=Value;
end;

procedure TPanteonesPagos.SetNroFactura(Value:variant);
begin
  FNroFactura:=Value;
end;

procedure TPanteonesPagos.SetNroComprobante(Value:string);
begin
  FNroComprobante:=Value;
end;

procedure TPanteonesPagos.SetObservaciones(Value:string);
begin
  FObservaciones:=Value;
end;

procedure TPanteonesPagos.SetFecha_A(Value:string);
begin
  FFecha_A:=Value;
end;

procedure TPanteonesPagos.SetUsu_A(Value:variant);
begin
  FUsu_A:=Value;
end;

procedure TPanteonesPagos.SetEnMovimientos(Value:boolean);
begin
  FEnMovimientos:=Value;
end;

procedure TPanteonesPagos.SetConfirmado(Value:boolean);
begin
  FConfirmado:=Value;
end;

procedure TPanteonesPagos.SetUsuConfirma(Value:variant);
begin
  FUsuConfirma:=Value;
end;

procedure TPanteonesPagos.SetFechaConfirma(Value:string);
begin
  FFechaConfirma:=Value;
end;

procedure TPanteonesPagos.SetAnulado(Value:boolean);
begin
  FAnulado:=Value;
end;

procedure TPanteonesPagos.SetUsuAnula(Value:variant);
begin
  FUsuAnula:=Value;
end;

procedure TPanteonesPagos.SetFechaAnula(Value:string);
begin
  FFechaAnula:=Value;
end;

procedure TPanteonesPagos.SetMotivoAnula(Value:string);
begin
  FMotivoAnula:=Value;
end;

procedure TPanteonesPagos.SetIdCobro(Value:variant);
begin
  FIdCobro:=Value;
end;

Function TPanteonesPagos.BuscarPK(ValorBuscado:String):boolean;
...
//Realizo la Consulta
Result:=FCapaDatos.BuscarSP('SPC_PanteonesPagosConsultar',Parametros,DataSet,1);
...
Function TPanteonesPagos.ListarSP(var Parametros:TWideStrings; var DataSet:TClientDataSet; MaxRecord:integer):boolean;
begin
//Instancio la Capa de Datos
FCapaDatos:=TCapaDatos.Create(nil);
FCapaDatos.ConnectionString:=FConnectionString;
...
//Realizo la Consulta
Result:=FCapaDatos.BuscarSP('SPC_PanteonesPagosConsultar',Parametros,DataSet,MaxRecord);

//Libero Memoria
FCapaDatos.Free;
end;

Function TPanteonesPagos.Listar(Consulta:widestring; var DataSet:TClientDataSet):boolean;
begin
//Instancio la Capa de Datos
FCapaDatos:=TCapaDatos.Create(nil);
FCapaDatos.ConnectionString:=FConnectionString;
...
Function TPanteonesPagos.ListarSinResp(Consulta:widestring):boolean;
begin
//Instancio la Capa de Datos
FCapaDatos:=TCapaDatos.Create(nil);
FCapaDatos.ConnectionString:=FConnectionString;
...
Function TPanteonesPagos.Agrega():boolean;
var DataSet:TClientDataSet;
    Parametros:TWideStrings;
begin
//Instancio el DataSet
...
//Realizo la Consulta
Result:=FCapaDatos.BuscarSP('SPC_PanteonesPagosInsertar',Parametros,DataSet,1);
...
Function TPanteonesPagos.Borrar(ValorBuscado:string):boolean;
...
//Realizo la Consulta
Result:=FCapaDatos.EjecutarSinResp('SPC_PanteonesPagosEliminar',Parametros);
...
Function TPanteonesPagos.Modificar():boolean;
var Parametros:TWideStrings;
begin
//Instancio el Contenedor de Parametros
Parametros:=TWideStrings.Create;
...
//Realizo la Consulta
Result:=FCapaDatos.EjecutarSinResp('SPC_PanteonesPagosModificar',Parametros);
