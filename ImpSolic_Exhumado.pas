...
var posfx,posfy,posfin,pos_y,salto:double;
   ...
   begin
    with gerimp do begin
     ...
     BaseReport.PrintXY(posx+130,posy+27,'ORDEN DE EXHUMACION Nº: ');
 ...
 Function Logo(posx,posy:double;vaf:integer):double;
   ...
   begin
    with RvOrden do begin
     ...
     //BaseReport.PrintXY(posx+130,posy+27,'SERV. Nº: '+ idcrema);
     BaseReport.PrintXY(posx+130,posy+27,'SERV. Nº: ');
